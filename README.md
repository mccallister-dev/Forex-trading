...
| `SMC_Context_Companion_v1.pine` | Indicator | Chart-aligned HTF pullback-continuation and sweep-reversal models with session context, OB/FVG proxies and filtered BUY/SELL plans. |
